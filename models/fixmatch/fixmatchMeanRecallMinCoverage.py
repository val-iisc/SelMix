...
class FixMatch:
    ...
    def val(self, args=None):
        ...
        self.lambdas = LambdaUpdate.MinCoverage(CM, self.lambdas, args.val_lr, type=self.args.update_type)
        lambda_dict = {}
        for i in range(self.num_classes):
            lambda_dict["lambda:"+ str(i)] = self.lambdas[i]
        
        print(self.lambdas)
        joint_dist = JointDistributions.MinCoverage(CM, self.lambdas, T=1.0, type=self.args.update_type)
