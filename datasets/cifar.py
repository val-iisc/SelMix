...
class SSL_LT_Dataset:
    ...
    def __init__(self, name='cifar100', train=True, num_classes=100, data_dir='./data',
        ...
        self.transform = get_transform(self.mean[name], self.std[name], train, 32 if 'cifar' in name else 96)
    ...
    def get_dataset(self):
        ...
        val_dset = BasicDataset(self.val_data, self.val_targets, self.classes, self.num_classes,
                                get_transform(self.mean[self.name], self.std[self.name], False), False, None, False)
