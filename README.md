...
### Weights & Biases (wandb)
Since we extensively log various detailed performance measures for the model, we strongly recommend installing wandb before proceeding further. You can find the instruction [here](https://docs.wandb.ai/guides/hosting/self-managed/basic-setup)
>>>>>>> ac04dd6... A new start
...
| Dataset  | CIFAR-10 | CIFAR-10 | CIFAR-10 | CIFAR-100 |
|----------|-----------------------|-----------------------|-----------------------|---------------------|
|  | $N_1 = 1500, M_1 = 3000$ | $N_1 = 1500, M_1 = 3000$ | $N_1 = 1500, M_1 = 30$  | $N_1 = 150, M_1 = 300$  |
|          | $\rho_l = 100, \rho_u = 100$ | $\rho_l = 100, \rho_u = 1$ | $\rho_l = 100, \rho_u = 0.01$ |$\rho_l = 10, \rho_u = 10$ |
|     Fixmatch     | [Google Drive Link](insert_link_here) | [Google Drive Link](insert_link_here) | [Google Drive Link](insert_link_here) |[Google Drive Link](insert_link_here) |
|     w/ LA     | [Google Drive Link](insert_link_here) | [Google Drive Link](insert_link_here) | [Google Drive Link](insert_link_here) | [Google Drive Link](insert_link_here) |




| Dataset  | STL-10 | Imagenet-100 | 
|----------|---------------------|---------------------|
|          | $N_1 = 450, M_1 = Unk$ |$N_1 = 433, M_1 = 866$ | 
|          | $\rho_l = 10, \rho_u = Unk$ | $\rho_l = 10, \rho_u = 10$ |
|    FixMatch      | [Google Drive Link](insert_link_here) |[Google Drive Link](insert_link_here) |
|    w/ LA      | [Google Drive Link](insert_link_here) | [Google Drive Link](insert_link_here) |
