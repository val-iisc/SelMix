...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if 'cifar' in args.dataset:
        train_dset = train_ssl_dataset( name=args.dataset, train=True, num_classes=args.num_classes,\
                                        include_train=False, use_strong_transform=True,\
                                        N1=args.N1, M1=args.M1, imbalance_l=args.imbalance_l,\
                                        imbalance_u=args.imbalance_u, uratio=2)
    
        lb_dset, ulb_dset, _ = train_dset.lb_dset, train_dset.ulb_dset, train_dset.val_dset
